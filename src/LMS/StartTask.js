 ...
 function StartTask() {
        ...
        const interval = setInterval(() => {
            setRemainingTime(prevTime => {
                ...
                if (newTime === 0) {
                    ...
                    axios.post('http://localhost:8086/reports/save', {file: "Not Completed", notes: "Not Completed", status: "Not Completed" })
                        .then(response => {
    ...
    const saveNotes = async () => {
        ...
        if (isConfirmed) {
            ...
            try {
                const response = await axios.post('http://localhost:8086/reports/save', formData);
    ...
    function calculate(startTime, endTime) {
       ...
       const handleBack = (event) => {
        ...
        window.history.pushState(null, null, 'http://localhost:3000/start-task');
    };

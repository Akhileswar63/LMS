...
const columns = [
  { id: 'id', label: 'ID', minWidth: 10, marginleft: 10},
  { id: 'trainerName', label: 'Trainer Name', minWidth: 150 },
  { id: 'dateTime', label: 'Date Time', minWidth: 100 },
  { id: 'taskName', label: 'Task Name', minWidth: 100 },
  { id: 'taskDescription', label: 'Task Description', minWidth: 170 },
...
export default function ViewAllTask() {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get('http://localhost:8085/task/allTask'); // Replace '/api/tasks' with your actual backend endpoint
  ...
  return (
    <Paper style={{marginLeft:'240px', width: '80%', overflow: 'hidden' }}>
